...
Partial Class Form2
    ...
    Private Sub InitializeComponent()
        ...
        Me.RichTextBox1.Text = "Inserisci le tue credenziali in questo campo e la password che hai scelto negli a" &
    "ppositi spazi qui sotto, subito dopo clicca su ""salva"", oppure usa il menu sopra" &
    " questa zona di testo."
        ...
        Me.Label1.Text = "Inserisci Password"
        ...
        Me.Label2.Text = "Ripeti Password"
        ...
        Me.Carica.ToolTipText = "Carica Databse"
        '
        'Salva
        '
        ...
        Me.Salva.ToolTipText = "Salva Database"
        '
        'ToolStripSeparator1
        '
